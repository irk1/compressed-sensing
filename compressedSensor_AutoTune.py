...
def stochastic_auto_tune(image_path, out_dir="dataset", sample_fraction=0.4, grayscale=True,
    ...
    if best_result is not None:
        ...
        print(f"PSNR at Best MSE={best_psnr:.2f} dB")  # PSNR reporting

        # Load original and sampled images as generated by the dataset
        ...
        axes[2].set_title("Best Reconstructed")
        axes[2].axis("off")
...
if __name__ == "__main__":
    stochastic_auto_tune(
        ...
        sample_fraction=0.5,
        grayscale=True,
        initial_params={'wavelet':'db2','level':5,'n_iter':98,'lam':0.04859831045741074,'step':1.2520136539909963},
        n_trials=20
    )
